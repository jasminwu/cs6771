...
Function overloading is when multiple functions have the same name, but different parameters. The compiler will choose the correct function to call based on the parameters provided.