...
Explicit type conversion is when you explicitly cast a variable to a different type. This is done by using the type name in parentheses before the variable name.