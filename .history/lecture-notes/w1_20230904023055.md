...
Declaring a variable means that you are telling the compiler about the existence of a variable. Defining a variable means that you are telling the compiler where the variable is stored and how to access it.